...
def main():
    ...
    .stars {
        ...
        box-shadow:
            5vw 8vh #fff, 12vw 15vh #fff, 18vw 5vh #fff, 25vw 20vh #fff,
            32vw 10vh #fff, 38vw 25vh #fff, 45vw 12vh #fff, 52vw 18vh #fff,
            58vw 6vh #fff, 65vw 22vh #fff, 72vw 9vh #fff, 78vw 16vh #fff,
            85vw 11vh #fff, 92vw 24vh #fff, 97vw 7vh #fff,
            8vw 35vh #fff, 15vw 42vh #fff, 22vw 30vh #fff, 28vw 48vh #fff,
            35vw 38vh #fff, 42vw 52vh #fff, 48vw 33vh #fff, 55vw 46vh #fff,
            62vw 36vh #fff, 68vw 50vh #fff, 75vw 40vh #fff, 82vw 55vh #fff,
            88vw 32vh #fff, 95vw 44vh #fff,
            3vw 58vh #fff, 10vw 65vh #fff, 17vw 55vh #fff, 24vw 70vh #fff,
            30vw 62vh #fff, 37vw 75vh #fff, 44vw 60vh #fff, 50vw 72vh #fff,
            57vw 68vh #fff, 64vw 78vh #fff, 70vw 66vh #fff, 77vw 80vh #fff,
            83vw 58vh #fff, 90vw 74vh #fff, 96vw 64vh #fff,
            6vw 85vh #fff, 14vw 92vh #fff, 20vw 88vh #fff, 27vw 95vh #fff,
            34vw 82vh #fff, 41vw 90vh #fff, 47vw 85vh #fff, 54vw 96vh #fff,
            60vw 89vh #fff, 67vw 94vh #fff, 73vw 86vh #fff, 80vw 93vh #fff,
            86vw 84vh #fff, 93vw 91vh #fff, 99vw 87vh #fff;
