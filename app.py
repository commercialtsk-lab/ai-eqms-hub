...
def main():
    ...
    # =====================================================================
        ...
        st.markdown("""
        <style>
        /* Chat quick question buttons - BLACK bold text, bigger */
        [data-testid="stMain"] .stHorizontalBlock .stButton > button {
            color: #000000 !important;
            -webkit-text-fill-color: #000000 !important;
        ...
        [data-testid="stMain"] .stHorizontalBlock .stButton > button:hover {
